...
public class Poker {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("请输入Black的手牌：");
        String Blackcard = in.nextLine();
        System.out.println("请输入White的手牌：");
        String Whitecard = in.nextLine();
        String res = poker.compare(Blackcard, Whitecard);
    ...
    private String cmpPoint(int b, int w) {
        if (b == w) {
            return "Tie";
        } else if (b > w) {
            return "Black wins  ";
    ...
    private static ArrayList<String> splitColor(String cards) {
        ...
        String[] cardSplits = cards.split(" ");
        for (String card : cardSplits) {
            cardList.add(card.substring(card.length() - 1));
        }
        return cardList;
    }
}
